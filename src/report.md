...
![docker_pull](./images/01/docker_pull.png)

- **Проверили наличие докер образа через `docker images`**
![docker_images](./images/01/docker_images.png)
...
![docker_run](./images/01/docker_run.png)

- **Проверили, что образ запустился через `docker ps`**
![docker_ps](./images/01/docker_ps.png)
...
![docker_inspect](./images/01/docker_inspect.png)


- размер контейнера  
![size2](./images/01/docker_size.png)

- список замапленных портов  
![ports](./images/01/ports.png)
...
![nginx_81](./images/03/nginx_81.png)
	...
	![update](./images/03/update.png)
	![install](./images/03/install.png)
	
	- Скомпилировали и **запустили написанный мини сервер через spawn-fcgi на порту 8080**
	![compilation](./images/03/compilation.png)
...
`docker cp nginx.conf beautiful_rubin:/etc/nginx/nginx.conf`
